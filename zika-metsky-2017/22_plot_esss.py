...
# Non-alpha datasets
delphy_a_log = Log(
    filename='delphy_outputs_a/zika_delphy.log',
...
delphy_b_log = Log(
    filename='delphy_outputs_b/zika_delphy.log',
...
compare_logs(
    [(delphy_a_log,   47 + 31.616/60.0),
     (beast2_log,    319 + 24.679/60.0),
     (beastX_log,    301 + 49.909/60.0)],
    'plots/ESSDelphyAVsBeast2VsBeastX.pdf'
)
compare_logs(
    [(delphy_b_log,   47 + 45.573/60.0),
     (beast2_log,    319 + 24.679/60.0),
     (beastX_log,    301 + 49.909/60.0)],
...
delphy_alpha_a_log = Log(
    filename='delphy_outputs_alpha_a/zika_delphy_alpha.log',
...
delphy_alpha_b_log = Log(
    filename='delphy_outputs_alpha_b/zika_delphy_alpha.log',
...
compare_logs(
    [(delphy_alpha_a_log,         62 + 16.574/60.0),
     (beast2_alpha_log,          870 + 17.441/60.0),
     (beastX_alpha_log,          889 + 38.150/60.0),
     ],
    'plots/ESSDelphyAVsBeast2VsBeastXAlpha.pdf'
)
compare_logs(
    [(delphy_alpha_b_log,         61 + 51.698/60.0),
     (beast2_alpha_log,          870 + 17.441/60.0),
     (beastX_alpha_log,          889 + 38.150/60.0),
     ],
