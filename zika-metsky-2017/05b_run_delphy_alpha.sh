...
../delphy_mcc delphy_outputs_alpha_b/zika_delphy_alpha.trees delphy_outputs_alpha_b/zika_delphy_alpha.mcc
../loganalyser277 -burnin 30 delphy_outputs_alpha_b/zika_delphy_alpha.log >delphy_outputs_alpha_b/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_alpha_b/zika_delphy_alpha.trees > delphy_outputs_alpha_b/tree_ess.json
