...
if __name__ == "__main__":
    ...
    comparisons = [
        ...
        (
            str(here / "beast2_run" / "output.trees"),
            str(here / "delphy_outputs_a" / "zika_delphy.trees"),
            "BEAST 2", "Delphy A",
            "clade_comparison_beast2_vs_delphy_a",
        ),
        (
            str(here / "beast2_run" / "output.trees"),
            str(here / "delphy_outputs_b" / "zika_delphy.trees"),
            "BEAST 2", "Delphy B",
            "clade_comparison_beast2_vs_delphy_b",
        ),
        (
            str(here / "beast2_run_alpha" / "output.trees"),
            str(here / "delphy_outputs_alpha_a" / "zika_delphy_alpha.trees"),
            "BEAST 2 Alpha", "Delphy Alpha A",
            "clade_comparison_beast2_alpha_vs_delphy_alpha_a",
        ),
        (
            str(here / "beast2_run_alpha" / "output.trees"),
            str(here / "delphy_outputs_alpha_b" / "zika_delphy_alpha.trees"),
