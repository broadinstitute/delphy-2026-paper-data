...
time ../delphy \
   ...
   --v0-out-log-file delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.log \
   --v0-log-every   2000000 \
   --v0-out-trees-file delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.trees \
   --v0-tree-every 20000000 \
   --v0-out-delphy-file delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.dphy \
...
../delphy_mcc delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.trees delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.mcc
../loganalyser277 -burnin 30 delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.log >delphy_outputs_b/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_b/h5n1-andersen-e756a15-ALL_full_dates_only_b.trees > delphy_outputs_b/tree_ess.json
