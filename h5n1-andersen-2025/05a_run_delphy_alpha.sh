...
time ../delphy \
   ...
   --v0-out-log-file delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.log \
   --v0-log-every   2000000 \
   --v0-out-trees-file delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.trees \
   --v0-tree-every 20000000 \
   --v0-out-delphy-file delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.dphy \
...
../delphy_mcc delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.trees delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.mcc
../loganalyser277 -burnin 30 delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.log >delphy_outputs_alpha_a/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_alpha_a/h5n1-andersen-e756a15-ALL_full_dates_only_alpha_a.trees > delphy_outputs_alpha_a/tree_ess.json
