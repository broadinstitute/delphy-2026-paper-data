...
time ../beastX1050 \
     -beagle \
     -working \
     beastX_run_a/h5n1-andersen-e756a15-ALL_full_dates_only.xml

../delphy_mcc beastX_run_a/output.trees beastX_run_a/h5n1-andersen-e756a15-ALL_full_dates_only_beastX.mcc
