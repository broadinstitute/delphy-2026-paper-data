#!/usr/bin/env python3
"""Generate all simulation inputs and a Makefile for the tip-date-uncertainty WCSS.
...
# Path to binaries (relative to the 11_tip_date_uncertainty directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
...
def main():
    ...
    print(f"  tip-date uncertainty: month={P_TIP_DATE_UNCERTAIN_UPTO_MONTH}, "
          f"year={P_TIP_DATE_UNCERTAIN_UPTO_YEAR}")
    print()
    ...
    for i in range(n):
        ...
        n0, g, mu, kappa, pi, alpha = sample_prior_params(
