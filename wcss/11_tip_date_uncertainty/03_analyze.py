...
def _classify_tip_col(col_name):
    ...
    """
    # col_name: tipYear(TIP_XXX|YYYY-MM) or tipYear(TIP_XXX|YYYY)
...
def analyze_tip_dates(script_dir, analyses_dir, included, burnin_frac,
    ...
    Uses loganalyser results for mean and HPD.  Reads raw samples from
    delphy-tips.log for normalized rank computation.
    """
    month_results = []
    year_results = []
