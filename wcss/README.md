...
- **`.dphy`** — Delphy snapshot files (binary, very large).
- **`.fasta`** — Simulated sequence alignments.  These can be
  regenerated by rerunning `01_generate.py` and are conceptually
  identical to the corresponding `.maple` files.
