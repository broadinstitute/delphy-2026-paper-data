#!/usr/bin/env python3
"""Generate all simulation inputs and a Makefile for the Skygrid WCSS.
...
# Inverse-Gamma prior on N_bar (in years): mean=1, stddev=0.2
# InvGamma: mean = beta/(alpha-1), var = beta^2/((alpha-1)^2*(alpha-2))
# => alpha = 2 + mean^2/var = 27, beta = mean*(alpha-1) = 26
NBAR_PRIOR_MEAN = 1.0
NBAR_PRIOR_STDDEV = 0.2
NBAR_PRIOR_ALPHA = 2.0 + NBAR_PRIOR_MEAN**2 / NBAR_PRIOR_STDDEV**2  # 27.0
NBAR_PRIOR_BETA = NBAR_PRIOR_MEAN * (NBAR_PRIOR_ALPHA - 1.0)         # 26.0
...
# Path to binaries (relative to the 10_skygrid directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
