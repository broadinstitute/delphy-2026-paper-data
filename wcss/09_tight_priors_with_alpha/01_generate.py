#!/usr/bin/env python3
"""Generate all simulation inputs and a Makefile for the tight-priors-with-alpha WCSS.
...
# Path to binaries (relative to the 09_tight_priors_with_alpha directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
