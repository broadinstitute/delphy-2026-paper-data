...
# Inverse-Gamma prior on N_bar (in years): mean=0.75, stddev=0.15
# InvGamma: mean = beta/(alpha-1), var = beta^2/((alpha-1)^2*(alpha-2))
# => alpha = 2 + mean^2/var = 27, beta = mean*(alpha-1) = 19.5
NBAR_PRIOR_MEAN = 0.75
NBAR_PRIOR_STDDEV = 0.15
NBAR_PRIOR_ALPHA = 2.0 + NBAR_PRIOR_MEAN**2 / NBAR_PRIOR_STDDEV**2  # 27.0
NBAR_PRIOR_BETA = NBAR_PRIOR_MEAN * (NBAR_PRIOR_ALPHA - 1.0)         # 19.5
...
# Path to binaries (relative to the 22_final_skygrid directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
