...
Variant of study 23 with no year-long tip-date uncertainty and a different seed.
...
P_TIP_DATE_UNCERTAIN_UPTO_YEAR = 0.0   # <-- Changed from 0.05 in study 23
...
DEFAULT_MASTER_SEED = 9999  # <-- Different from study 23 (2025)

# Path to binaries (relative to the 23b_exponential_no_year_uncertainty directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
