#!/usr/bin/env python3
"""Generate all simulation inputs and a Makefile for the missing-data (no alpha) WCSS.
...
# Path to binaries (relative to the 07_missing_data_no_alpha directory)
SAPLING_REL = "../../sapling"
DELPHY_REL = "../../delphy"
...
def main():
    ...
    for i in range(n):
        ...
        n0, g, mu, kappa, pi = sample_prior_params(rng)
