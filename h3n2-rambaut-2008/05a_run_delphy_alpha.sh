...
time ../delphy \
   ...
   --v0-steps 1000000000 \
   --v0-out-log-file delphy_outputs_alpha_a/h3n2_alpha.log \
   --v0-log-every 100000 \
   --v0-out-trees-file delphy_outputs_alpha_a/h3n2_alpha.trees \
   --v0-tree-every 1000000 \
   --v0-out-delphy-file delphy_outputs_alpha_a/h3n2_alpha.dphy \
...
../delphy_mcc delphy_outputs_alpha_a/h3n2_alpha.trees delphy_outputs_alpha_a/h3n2_alpha.mcc
../loganalyser277 -burnin 30 delphy_outputs_alpha_a/h3n2_alpha.log >delphy_outputs_alpha_a/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_alpha_a/h3n2_alpha.trees > delphy_outputs_alpha_a/tree_ess.json
