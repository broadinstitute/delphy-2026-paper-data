...
time ../delphy \
   ...
   --v0-steps 1000000000 \
   --v0-out-log-file delphy_outputs_b/h3n2.log \
   --v0-log-every 100000 \
   --v0-out-trees-file delphy_outputs_b/h3n2.trees \
   --v0-tree-every 1000000 \
   --v0-out-delphy-file delphy_outputs_b/h3n2.dphy \
...
../delphy_mcc delphy_outputs_b/h3n2.trees delphy_outputs_b/h3n2.mcc
../loganalyser277 -burnin 30 delphy_outputs_b/h3n2.log >delphy_outputs_b/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_b/h3n2.trees > delphy_outputs_b/tree_ess.json
