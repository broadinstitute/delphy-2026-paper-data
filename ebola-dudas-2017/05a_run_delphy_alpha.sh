...
time ../delphy \
   ...
   --v0-out-log-file delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.log \
   --v0-log-every 2000000 \
   --v0-out-trees-file delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.trees \
   --v0-tree-every 10000000 \
   --v0-out-delphy-file delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.dphy \
...
../delphy_mcc delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.trees delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.mcc
../loganalyser277 -burnin 30 delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.log >delphy_outputs_alpha_a/log_analysis.txt
../calc-tree-ess --compact --burnin-pct 30 delphy_outputs_alpha_a/ebola_dudas_alpha_delphy.trees > delphy_outputs_alpha_a/tree_ess.json
