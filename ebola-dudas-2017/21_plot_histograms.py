...
def compare_logs(
    ...
    # Skygrid plots
    t0 = bt.decimalDate("2015-10-24")  # Hard-coded, but ok
    ...
    ax1.set_xlim((bt.decimalDate("2013-08-01"), bt.decimalDate("2015-11-01")))  # A little bit less on the right to align with tree
...
# Non-alpha datasets
ml_results = extract_ml_results('ml/ebola_dudas.iqtree', 'ml/tt', False)
delphy_a_log = Log(
...
# Alpha datasets
ml_results_alpha = extract_ml_results('ml/ebola_dudas_alpha.iqtree', 'ml/tt_alpha', True)
