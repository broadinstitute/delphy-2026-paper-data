...
compare_logs(
    [(delphy_a_log,    6 + 53.707/60.0),
     (beast2_log,     66 + 37.503/60.0),
     (beastX_log,     35 + 41.327/60.0)],
    'plots/ESSDelphyAVsBeast2VsBeastX.pdf'
)
compare_logs(
    [(delphy_b_log,    6 + 49.028/60.0),
     (beast2_log,     66 + 37.503/60.0),
     (beastX_log,     35 + 41.327/60.0)],
...
compare_logs(
    [(delphy_alpha_a_log,         12 + 36.511/60.0),
     (beast2_alpha_log,           87 + 20.404/60.0),
     (beastX_alpha_log,           74 + 18.941/60.0),
     ],
    'plots/ESSDelphyAVsBeast2VsBeastXAlpha.pdf'
)
compare_logs(
    [(delphy_alpha_b_log,         12 + 32.471/60.0),
     (beast2_alpha_log,           87 + 20.404/60.0),
     (beastX_alpha_log,           74 + 18.941/60.0),
     ],
